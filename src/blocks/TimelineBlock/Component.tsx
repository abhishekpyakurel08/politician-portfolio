...
const defaultTimelineItems = [
  ...
  },
  {
    ...
    description:
      'CMA (Certified Medical Assistant) अध्ययन पूरा गर्नुका साथै पलाँता युवा सञ्जालको अध्यक्ष भई राहत वितरण, सचेतना र सामाजिक कार्यमा सक्रियता।',
    category: 'सामाजिक',
  },
  {
    year: '२०७९',
    ...
    description:
      'कालिकोटको पलाँता गाउँपालिकाबाट उपाध्यक्ष पदमा नेकपा एमालेको तर्फबाट उम्मेदवारी र १५९८ मत (७२ मतको अन्तर) सहित सशक्त उपस्थिति।',
    category: 'निर्वाचन',
  },
  {
    year: '२०७९ फागुन',
    ...
    description:
      'केन्द्रीय महाधिवेशनबाट केन्द्रीय सदस्यमा निर्वाचित र कालिकोट जिल्ला इन्चार्जको जिम्मेवारी प्राप्त।',
    category: 'पार्टी',
  },
  {
    year: 'पछिल्लो समय',
    ...
    description:
      'नेकपा एमाले कालिकोट जिल्ला अधिवेशनबाट लेखा आयोगको अध्यक्षमा निर्वाचित। साथै, नेकपा एमालेको एघारौँ महाधिवेशन प्रतिनिधिको भूमिका।',
    category: 'पार्टी',
  },
]
...
export const TimelineBlock = async ({
  ...
  const finalTitle =
    title ||
    (locale === 'en' ? 'My Political and Social Journey' : 'मेरो राजनीतिक तथा सामाजिक यात्रा')
  const finalSubtitle =
    subtitle ||
    (locale === 'en'
      ? 'A glorious history of continuous struggle and public service since 2070'
      : '२०७० सालदेखिको निरन्तर सङ्घर्ष र जनसेवाको गौरवमय इतिहास')
      ...
      <div className="container relative z-10">
                  ...
                  <div className="absolute left-8 md:left-1/2 top-0 md:top-1/2 -translate-x-1/2 translate-y-0 md:-translate-y-1/2 z-20">
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-white shadow-2xl border-[6px] border-[#B31B20]/20 flex items-center justify-center group cursor-pointer hover:scale-110 transition-transform duration-500 relative">
                      ...
                      <span className="text-[#B31B20] font-black leading-none text-center relative z-10 mukta-bold">
                        <div className="text-[10px] md:text-xs uppercase opacity-60">
                          {locale === 'en' ? 'Year' : 'वर्ष'}
                        </div>
        ...
        <div className="mt-16 md:mt-24 text-center">
          <Button
            size="lg"
            asChild
            className="bg-[#B31B20] text-white border-none px-12 h-16 md:h-20 rounded-full font-black text-lg md:text-xl gap-4 hover:bg-slate-900 shadow-2xl shadow-red-900/40 transition-all hover:-translate-y-2 mukta-bold uppercase tracking-widest leading-none"
          >
            <Link href={`/${locale}/about`}>
              {locale === 'en' ? 'View All History' : 'पूरा इतिहास हेर्नुहोस्'}{' '}
