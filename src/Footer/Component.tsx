          ...
          <div className="space-y-8 col-span-1 md:col-span-2 lg:col-span-1 h-full flex flex-col justify-between">
            ...
            <div className="flex gap-3">
              <Button
                ...
                size="icon"
                variant="ghost"
                className="bg-white/5 hover:bg-[#1877F2] hover:text-white rounded-xl transition-all duration-300 w-11 h-11"
              >
                <Link href="https://facebook.com/jasmin.xeetri" target="_blank">
              ...
              <Button
                ...
                size="icon"
                variant="ghost"
                className="bg-white/5 hover:bg-[#E4405F] hover:text-white rounded-xl transition-all duration-300 w-11 h-11"
              >
              ...
              <Button
                ...
                size="icon"
                variant="ghost"
                className="bg-white/5 hover:bg-red-600 hover:text-white rounded-xl transition-all duration-300 w-11 h-11"
              >
                <Link href="#" target="_blank">
